...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('postgres', 'PostgresDBsuperuser', 'localhost:5432', self.database_name)
        ...
        self.new_question = {
            'question': 'What is the name of the past president of the united states ?',
            'answer': 'Donald Trump',
            'category': 4,
            'difficulty': 1
        }
